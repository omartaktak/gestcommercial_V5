...
/**
 * BonCaisse generated by hbm2java
 */
@Entity
@Getter
@Setter
public class BonCaisse  {
	...
	public BonCaisse(String cbonCaisse, String client, String regimeTva,
			String sessionCaisse, String transformer,
			String raisonSociale, String soldee, Date dateCreation,
			Date dateModification, Date datePiece, Date heurePiece,
			boolean fodec, BigDecimal tauxFodec, boolean taxeSurTtc,
			BigDecimal tauxTaxeSurTtc, BigDecimal mtHtbrut0,
		...
		this.csessionCaisse = sessionCaisse;
	...
	public BonCaisse(String cbonCaisse, String representant,
			String client, String regimeTva, String sessionCaisse,
			String transformer, String raisonSociale, String cin,
			String soldee, Date dateCreation, Date dateModification,
			Date datePiece, Date heurePiece, boolean fodec,
			BigDecimal tauxFodec, boolean taxeSurTtc,
			BigDecimal tauxTaxeSurTtc, String desAdresseClient,
			String paysClient, String villeClient, String regionClient,
			String codePostalClient, String tel, String gsm,
