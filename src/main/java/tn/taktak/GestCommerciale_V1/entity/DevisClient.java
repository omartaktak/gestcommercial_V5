...
/**
 * DevisClient generated by hbm2java
 */
@Entity
@Getter
@Setter
public class DevisClient  {
	...
	public DevisClient(String cdevisClient, String cclient, String cregimeTva,
			String transformer, Date dateCreation, Date dateModification,
